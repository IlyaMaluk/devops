...
am_my_program_OBJECTS = main.$(OBJEXT) factorial.$(OBJEXT) \
	TrigonometryClass.$(OBJEXT)
...
am__depfiles_remade = ./$(DEPDIR)/TrigonometryClass.Po \
	./$(DEPDIR)/factorial.Po ./$(DEPDIR)/main.Po
am__mv = mv -f
AM_V_lt = $(am__v_lt_$(V))
...
ACLOCAL = ${SHELL} '/mnt/c/users/ilya/source/repos/devops/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/mnt/c/users/ilya/source/repos/devops/missing' autoconf
AUTOHEADER = ${SHELL} '/mnt/c/users/ilya/source/repos/devops/missing' autoheader
AUTOMAKE = ${SHELL} '/mnt/c/users/ilya/source/repos/devops/missing' automake-1.16
AWK = gawk
CPPFLAGS = 
CSCOPE = cscope
CTAGS = ctags
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"myprogram\" -DPACKAGE_TARNAME=\"myprogram\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"myprogram\ 1.0\" -DPACKAGE_BUGREPORT=\"321ilia465@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"myprogram\" -DVERSION=\"1.0\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/mnt/c/users/ilya/source/repos/devops/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = myprogram
PACKAGE_BUGREPORT = 321ilia465@gmail.com
...
STRIP = 
VERSION = 1.0
abs_builddir = /mnt/c/users/ilya/source/repos/devops
abs_srcdir = /mnt/c/users/ilya/source/repos/devops
abs_top_builddir = /mnt/c/users/ilya/source/repos/devops
abs_top_srcdir = /mnt/c/users/ilya/source/repos/devops
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /mnt/c/users/ilya/source/repos/devops/install-sh
...
my_program_SOURCES = lab2/lab2/main.cpp lab2/lab2/factorial.cpp lab2/lab2/TrigonometryClass.cpp
...
include ./$(DEPDIR)/TrigonometryClass.Po # am--include-marker
include ./$(DEPDIR)/factorial.Po # am--include-marker
...
distclean: distclean-am
	-rm -f $(am__CONFIG_DISTCLEAN_FILES)
		-rm -f ./$(DEPDIR)/TrigonometryClass.Po
	-rm -f ./$(DEPDIR)/factorial.Po
	-rm -f ./$(DEPDIR)/main.Po
	-rm -f Makefile
...
deb:
	...
	echo "Description: Hello world" >> $(CTRLF_NAME)
